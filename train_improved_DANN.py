...
def main():
    ...
    dataset_val = dataset.DA(dir=root, name=target, img_size=(224,224), train=True,real_val=False)
    ...
    for epoch in range(epochs):
        ...
        if best_acc < tot_t_acc:
            ...
            }, os.path.join(path_output, target + '-{}-deming.pth'.format(epoch)))
...
if __name__ == '__main__':
    main()
    info_training_loss = [14.818, 10.612, 9.2556, 8.4308, 7.7036, 7.288, 6.9831, 6.68, 6.4404, 6.1586, 5.9773, 5.8425, 5.7058, 5.5933, 5.4648, 5.3787, 5.3, 5.1899, 5.1028, 5.073, 4.926, 4.878, 4.861, 4.8531, 4.8422]
    sketch_loss = [15.75, 12.871, 11.544, 9.637, 8.442, 7.779, 7.221, 6.8843, 6.3418, 6.128, 5.162, 5.091, 4.9782, 4.7731, 4.5843, 4.381, 4.1204, 4.0819, 3.9375, 3.8246, 3.8142, 3.8066, 3.7869, 3.77, 3.7682]
    
    
    #print(len(sketch_loss))